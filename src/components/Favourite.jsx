...
export default function Favourites() {
  ...
  useEffect(() => {
    const dataFromLocalStorage = localStorage.getItem("imdb");
...
//   //   } catch (error) {
//   //     console.error("Error parsing old favorites:", error);
//   //     setFavourites([]);
//   //   }
//   // }, []);
...
//   const dataFromLocalStorage = localStorage.getItem("imdb");
//   if (dataFromLocalStorage) {
//     setOldFav(JSON.parse(dataFromLocalStorage));
//   }
// }, []);

//   // Assume this is where the error occurs
//   let temp = favoutrites.map((movie) => genreids[movie.genre_ids[0]]);
...
//   let del = (movie) => {
//     let newArray = favoutrites.filter((m) => m.id !== movie.id);
//     setFavourites(newArray);
//     localStorage.setItem("imdb", JSON.stringify(newArray));
//   };

//   // Filtered movies
//   let filteredMovies = curGenre === "ALL Genres" ? favoutrites : favoutrites.filter((movie) => genreids[movie.genre_ids[0]] === curGenre);
...
//           <button
//             key={genre}
//             className={curGenre === genre ? 'm-2 text-xl p-1 px-2 bg-sky-600 text-white rounded-xl font bold' : 'm-2 text-xl p-1 px-2 bg-gray-400 hover:bg-sky-600 text-white rounded-xl font bold'}
//             onClick={() => {
//               setCurPage(1);
//               setCurGenre(genre);
//             }}
...
//                       </td>
//                       <td className='px-6 py-4 whitespace-nowrap'>
//                         <span className='px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800'>{genres[movie.genre_ids[0]]}</span>
//                       </td>
//                       <td className='px-6 py-4 whitespace-nowrap text-sm font-medium text-center'>
...
//   // Initialize temp after favoutrites state is set
//   let temp = favoutrites.map((movie) => genreids[movie.genre_ids[0]]);
